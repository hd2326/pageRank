...
#'
#' @param null (ecdf) Null distribution of probability-based distance. Either from random interactions by P_null function, or all interactions in net.
#'
#' @param threshold (numeric) P-value threshold for filtering interactions in net.
#'
